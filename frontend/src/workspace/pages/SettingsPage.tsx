...
const SECTIONS: { id: SectionId; label: string; desc: string; icon: React.ReactNode }[] = [
  ...
  { id: "workspace", label: "Workspace", desc: "Workspace details and timezone.", icon: <IconWorkspace /> },
  { id: "brand", label: "Brand", desc: "Colors and default font.", icon: <IconBrand /> },
...
export function SettingsPage() {
  ...
  return <div className="flex min-h-0 flex-col overflow-hidden rounded-[12px] border border-c-border sm:flex-row">
