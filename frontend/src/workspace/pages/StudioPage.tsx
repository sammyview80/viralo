            ...
            {tab === "url" && (
              <div className="flex flex-col gap-4">
                <div className="flex flex-col gap-2 rounded-[18px] border border-white/[.08] bg-white/[.02] p-6">
                  ...
                  {urlReady && !uploading && (
                    ytMetaLoading ? (
                      <div className="flex items-center gap-3 rounded-[12px] border border-white/[.06] bg-white/[.03] p-3 animate-pulse">
                        <div className="w-28 h-16 rounded-[8px] bg-zinc-800 flex-shrink-0" />
                      ...
                      <div className="flex items-center gap-3 rounded-[12px] border border-emerald-400/15 bg-emerald-400/[.05] p-3">
                        <div className="relative flex-shrink-0 w-28 h-16 rounded-[8px] overflow-hidden bg-zinc-800">
                          <img src={ytMeta.thumbnail} alt={ytMeta.title} className="w-full h-full object-cover" />
                        ...
                        <div className="flex-1 min-w-0">
                          <p className="text-[12.5px] font-semibold text-white line-clamp-2 leading-snug">{ytMeta.title}</p>
                          <div className="flex items-center gap-1.5 mt-1.5">
                            <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2.5} className="text-emerald-400"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>
                            <span className="text-[11px] font-medium text-emerald-400">Ready to import</span>
                          </div>
                        </div>
                      </div>
                    ) : (
